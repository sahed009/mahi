		...
		>
			...
			<div className="basis-3/5 z-10 mt-16 md:mt-32 flex justify-center">
				{isAboveLarge ? (
					...
					<img
						alt="profile"
						className="z-10 w-full max-w-[600px] md:max-w-[500px] sm:max-w-[150px] animate__animated animate__backInLeft"
						src={require("../assets/chefs-photo.png")}
					/>
				)}
			</div>
			...
			<div className="z-30 basis-2/5 mt-12 md:mt-32">
				...
				<div>
					<p className="text-3xl md:text-4xl lg:text-5xl font-righteous px-20 py-5 rounded-3xl z-10 text-start font-bold shadow-2xl  animate__animated animate__fadeInDown animate__delay-1s">
                        <span className="text-[70px] md:text-[100px] text-[#ADA2FF]"> &#8220; </span><br />
						...
						<span
							className="xs:relative text-[#ADA2FF] xs:font-semibold
					...
					<p className="w-[100%] justify-center items-center my-5 py-2 font-righteous text-lg text-center text-[#ADA2FF] font-bold rounded-md px-5 md:text-start animate__animated animate__zoomInUp animate__delay-1s">
